...
public class DigestUtil {
	...
	public void MD5EncodeTest() {
    	String origin = "asynNotifyUrl=http://web.junengzhuan.cn/withdraw/withdrawNotify&merId=100519394&orderAmount=400&orderStatus=01&payId=918682905784360960&payTime=20171013114200&prdOrdNo=20171013114016UD1HHS&signType=MD5&transType=008&versionId=1.0&key=Jgvf4L71mSNi";
		String resultString = null;
		try {
			resultString = new String(origin);
			MessageDigest md = DigestUtils.getMd5Digest();
